...
namespace AirBladderUpgrades.Items.Capacity_Upgrades
{
    public class AirBladderCapacityUpgradeMk1 //all of these are nearly the same, just some name changes and very little behavior. let me know if i should change mk1, mk2, or 3.
    {
        ...
        {
            mk1capacityprefabinfo = PrefabInfo.WithTechType("AirBladderCapacityUpgradeMk1", "Air Bladder Capacity Upgrade Mk 1", "Mk 1 Capacity for the Air Bladder. Doubles the amount of Oxygen in the Air Bladder").WithIcon(SpriteManager.Get(TechType.AirBladder));
            ...
            mk1capacityprefab.SetPdaGroupCategory(Plugin.toolupgrademodules, Plugin.AirBladderUpgrades);
