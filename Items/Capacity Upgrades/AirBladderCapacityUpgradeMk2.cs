...
namespace AirBladderUpgrades.Items.Capacity_Upgrades
{
    public class AirBladderCapacityUpgradeMk2
    {
        ...
        {
            mk2capacityprefabinfo = PrefabInfo.WithTechType("AirBladderCapacityUpgradeMk2", "Air Bladder Capacity Upgrade Mk 2", "Mk 2 Capacity for the Air Bladder. Increases the amount of Oxygen in the Air Bladder to 60 seconds").WithIcon(SpriteManager.Get(TechType.AirBladder));
