...
namespace AirBladderUpgrades.Items.Capacity_Upgrades
{
    public class AirBladderCapacityUpgradeMk3
    {
        ...
        {
            mk3capacityprefabinfo = PrefabInfo.WithTechType("AirBladderCapacityUpgradeMk3", "Air Bladder Capacity Upgrade Mk 3", "Mk 3 Capacity for the Air Bladder. Increases the amount of Oxygen in the Air Bladder to 90 seconds").WithIcon(SpriteManager.Get(TechType.AirBladder));
