...
namespace AirBladderUpgrades
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            SetAirBladderUpgrades(TechType.AirBladder);//call the method
        ...
        public void Update()
        {
            ...
            if (heldtool is AirBladder) //chech if the tool is the air bladder
            {
                ...
                if (allowedtech == null) //check if the array is somehow null
                {
                    if (timer == 0)
                    {
                        Logger.LogInfo("allowedtech is Null! Further debugging required!");
                    }
                    return;
                }
